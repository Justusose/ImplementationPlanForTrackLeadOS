...
export const Icon = {
  Radar: (p: IconProps) => (
    <svg {...base(p)}>
      ...
      <path d="M12 12 8 8" />
      <path d="M16.24 7.76A6 6 0 1 0 12 18" />
  ...
  Naira: (p: IconProps) => (
    <svg {...base(p)}>
      <path d="M6 4v16M18 4v16M4 9h16M4 15h16M6 4l12 16" />
    </svg>
  ),
  Logout: (p: IconProps) => (
    <svg {...base(p)}>
  ...
  Meta: (p: IconProps) => (
    <svg {...base(p)}>
      <path d="M2 12c0-3 1.5-5 3.5-5 3 0 4.5 10 7 10 1.5 0 2-2 2-3M22 12c0-3-1.5-5-3.5-5-3 0-4.5 10-7 10" />
    </svg>
  ),
  Tiktok: (p: IconProps) => (
    <svg {...base(p)}>
